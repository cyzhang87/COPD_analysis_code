...
data_path = os.path.dirname(os.path.abspath(__file__)) + "/../data/our_data"
target_path = os.path.dirname(os.path.abspath(__file__)) + "/../data/our_data/target"
...
def processWordVocab(target_path, use_glove, k):
	...
	with open(data_path+"/crawled_data_splits.pkl", "rb") as f:
		_data = pickle.load(f)
